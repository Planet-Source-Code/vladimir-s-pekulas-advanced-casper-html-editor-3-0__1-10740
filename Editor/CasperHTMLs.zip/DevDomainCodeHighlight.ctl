...
'    strSeparator(14) = "}"
    iSeparatorCount = 5
    bFireSelectionChange = True
    rich.RightMargin = mDef_RightMargin
End Sub
...
Public Function GetLineCount() As Long
   GetLineCount = apiSendMessage(rich.hWnd, EM_GETLINECOUNT, 0, 0&)
End Function


Public Function GetFirstLine() As Long
   GetFirstLine = apiSendMessage(rich.hWnd, EM_GETFIRSTVISIBLELINE, 0, 0&)
End Function


Public Function GetLineSelected() As Long
   GetLineSelected = apiSendMessage(rich.hWnd, EM_LINEFROMCHAR, -1, 0&)
End Function
