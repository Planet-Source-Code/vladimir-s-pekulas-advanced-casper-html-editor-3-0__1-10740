...
'******************************************
'* Folder TreeView Control (compiled OCX) *
'* By: CCRP (http://www.mvps.org/ccrp/)   *
'******************************************
...
'
' Facts:
'  This program contains 5000+ lines of code as of August 16, 2000
